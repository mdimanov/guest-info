      ...
      <div>
        ...
        <div className="relative w-full">
          <select
            ...
            className="w-full border border-indigo-500 rounded-lg p-3 pr-10 bg-indigo-100 dark:bg-indigo-800 text-gray-900 dark:text-gray-100 dark:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 appearance-none cursor-pointer"
          >
